/obj/item/device/searcher
	...
	icon = 'mods/_fd/junk_heaven/icons/tools.dmi'
	...
	var/list/scanning = list(/obj/structure/abandoned_cryo, /obj/structure/intel_console)
	var/last_used = 0 //last world.time it was used.

/obj/item/device/searcher/proc/searcher_recharge(mob/user as mob)
...
/obj/item/device/searcher/afterattack(atom/A, mob/user as mob, proximity)
...
/obj/item/device/searcher/verb/verb_wipe()
	set src in usr
	set category = "Object"
...
/obj/item/device/searcher/attack_self(mob/living/carbon/user)
