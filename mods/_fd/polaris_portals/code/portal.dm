...
/obj/map_effect/portal
	...
	var/obj/map_effect/portal/counterpart = null // The portal line or master that this is connected to, on the 'other side'.
...
/obj/map_effect/portal/Crossed(atom/movable/AM)
...
/obj/map_effect/portal/master/Initialize()
...
/obj/map_effect/portal/master/hear_talk(mob/M, text, verb, datum/language_speaking)
	if(!counterpart)
		return
	var/mob/living/L = M
	var/turf/T = counterpart.get_focused_turf()
