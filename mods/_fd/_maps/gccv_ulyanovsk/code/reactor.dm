...
/obj/machinery/power/port_gen/pacman/super/module/use_tool(obj/item/O, mob/user)
...
/obj/machinery/reactor_enchancer/New()
	. = ..()
	dir = pick(1,2,4,8)

/obj/machinery/reactor_enchancer/proc/IsBroken()
	return (stat & (MACHINE_BROKEN_GENERIC|MACHINE_STAT_EMPED|MACHINE_BROKEN_NO_PARTS))

/obj/machinery/reactor_enchancer/proc/NoPower()
	return (stat & MACHINE_STAT_NOPOWER)

/obj/machinery/reactor_enchancer/proc/IsActive()
	if(IsBroken() || NoPower() || stat == MACHINE_STAT_MAINT)
		return
	return TRUE

/obj/machinery/reactor_enchancer/use_tool(obj/item/O, mob/user, obj/machinery/power/port_gen/pacman/super/module/R)
	if(reactor)
...
/obj/machinery/reactor_enchancer/proc/upgrade(unimprove)
...
/obj/item/stock_parts/circuitboard/pacman/super/module
	name = "circuit board (ICRER-6 nuclear generator)"
	icon = 'mods/_fd/_maps/gccv_ulyanovsk/icons/ulyanovsk.dmi'
...
/obj/item/stock_parts/circuitboard/pacman/super/module/enchancer
	name = "circuit board (ICRER-6 Efficiency Improver)"
	icon = 'mods/_fd/_maps/gccv_ulyanovsk/icons/ulyanovsk.dmi'
...
/obj/item/stock_parts/circuitboard/pacman/super/module/enchancer/radiation
	name = "circuit board (ICRER-6 Radiation Improver)"
...
/obj/item/stock_parts/circuitboard/pacman/super/module/enchancer/range
	name = "circuit board (ICRER-6 Range Booster)"
...
/obj/item/stock_parts/circuitboard/pacman/super/module/enchancer/fuel_efficiency
	name = "circuit board (ICRER-6 Nuclear Decay Moderator)"
...
/obj/item/stock_parts/circuitboard/pacman/super/module/enchancer/coolant_tank
	name = "circuit board (ICRER-6 Expansion Tank)"
