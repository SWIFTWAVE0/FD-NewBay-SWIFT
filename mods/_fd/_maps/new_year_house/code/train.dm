...
/datum/shuttle/autodock/multi/antag/train
	...
	arrival_message = "Сверхзвуковой поезд отбывает со станции 'Резиденция Верцетти', следующая станция - 'Южный сектор 13-B'. Пристегните ремни."
	departure_message = "Сверхзвуковой поезд отбывает со станции 'Южный сектор 13-B', следующая станция - 'Резиденция Верцетти'. Пристегните ремни."
