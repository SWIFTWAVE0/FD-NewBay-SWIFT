...
/datum/job/submap/prison_ship/player
	...
	supervisors = "none"
	info = "none"
	whitelisted_species = list(SPECIES_HUMAN,SPECIES_IPC,SPECIES_SPACER,SPECIES_GRAVWORLDER,SPECIES_VATGROWN,SPECIES_TRITONIAN,SPECIES_ALIEN,SPECIES_UNATHI,SPECIES_VOX,SPECIES_TAJARA)
