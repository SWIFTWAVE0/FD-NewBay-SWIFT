...
/obj/item/clothing/shoes/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_feet_resomi.dmi')
	LAZYSET(sprite_sheets_obj, SPECIES_RESOMI, 'packs/infinity/icons/obj/clothing/species/resomi/obj_feet_resomi.dmi')

//Gloves
/obj/item/clothing/gloves/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_hands_resomi.dmi')


//suit
/obj/item/clothing/suit/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_suit_resomi.dmi')
...
/obj/item/rig/eva/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_rig_back_resomi.dmi')
...
/obj/item/storage/belt/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_belt_resomi.dmi')

/obj/item/clothing/accessory/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_accessories_resomi.dmi')
...
/obj/item/storage/backpack/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_back_resomi.dmi')

// under
/obj/item/clothing/under/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_under_resomi.dmi')
...
/obj/item/clothing/ears/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_ears_resomi.dmi')

//mask
/obj/item/clothing/mask/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_mask_resomi.dmi')
...
/obj/item/clothing/glasses/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_eyes_resomi.dmi')
...
/obj/item/clothing/mask/plunger/equipped(M, slot)
	..()
	sprite_sheets[SPECIES_RESOMI] = (slot == slot_head ? 'mods/resomi_fd/icons/clothing/onmob_head_resomi.dmi' : 'mods/resomi_fd/icons/clothing/onmob_mask_resomi.dmi')

/obj/item/card/id/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/onmob_id_resomi.dmi')

/obj/item/handcuffs/Initialize()
	. = ..()
	LAZYSET(sprite_sheets, SPECIES_RESOMI, 'mods/resomi_fd/icons/clothing/misc.dmi')
